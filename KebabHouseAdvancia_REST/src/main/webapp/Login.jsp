...
<body
	...
	<div class="flex min-h-full flex-col justify-center lg:px-8">
		...
		<div class="sm:mx-auto sm:w-full sm:max-w-sm">
			...
			<p class="mt-10 text-center text-sm text-red-700">
				Not a member? <a href="#"
					class="font-semibold leading-6 text-amber-600 hover:text-amber-600">Register
					right now!</a>
			</p>
		</div>
	</div>
	...
	<div class="toast hidden">
		...
		<div class="toast-content ">
			...
			<div class="message">
				<span class="text text-1">Fail</span> <span class="text text-2">Your
					credential are wrong, pls try again !</span>
			</div>
		</div>
		<div class="progress"></div>
	</div>

	<button class="text-white" id="alertBoxButton" onclick="loginFailed()"
		onclick="stopTimeOuts()">loginFailedAlert</button>
